...
public class ClassMenu {
    ...
    public static Inventory getClassSelectionMenu(Player player) {
        ...
        Inventory inv = Bukkit.createInventory(null, 27, "Choose Your Class");
        ...
        inv.setItem(12, createMenuItem(Material.CROSSBOW, ChatColor.AQUA + "" + ChatColor.BOLD + "Start As An Archer!",
            Arrays.asList(
                "",
