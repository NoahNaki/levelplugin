 ...
 *       me.nakilex.levelplugin.waypoints.api.pathing.processing.ValidationProcessor}):</b> Determining
 *       whether a {@link me.nakilex.levelplugin.waypoints.api.wrapper.PathPosition} is traversable or meets
 ...
 *       me.nakilex.levelplugin.waypoints.api.provider.NavigationPointProvider}) and world boundaries, as the
 *       core engine is designed to be highly generic.
 *   <li><b>Cost Calculation ({@link
 *       me.nakilex.levelplugin.waypoints.api.pathing.processing.CostProcessor}):</b> Modifying the cost of
 ...
 * me.nakilex.levelplugin.waypoints.api.pathing.processing.Processor}) and are provided with contextual
 * information for the current search ({@link
 * me.nakilex.levelplugin.waypoints.api.pathing.processing.context.SearchContext}) and the specific node
 * being evaluated ({@link
 * me.nakilex.levelplugin.waypoints.api.pathing.processing.context.EvaluationContext}).
 *
 * <p>Users can configure a list of validators and cost calculators via the {@link
 * me.nakilex.levelplugin.waypoints.api.pathing.configuration.PathfinderConfiguration}. The engine will
