...
public final class HeuristicWeights {
    ...
    /**
     * Represents the default set of heuristic weights used for pathfinding calculations. This instance is initialized
     * with equal weights for all heuristic components: {@code manhattanWeight}, {@code octileWeight},
     * {@code perpendicularWeight}, and {@code heightWeight}, each set to 1.0.
     *
     ...
     *
     * @param manhattanWeight     The weight applied to the Manhattan distance component. A higher weight favours paths
     *                            with a greater emphasis on direct, axis-aligned movement.
     * @param octileWeight        The weight applied to the Octile distance component. A higher weight allows diagonal
     *                            movement, enabling more flexible paths in 3D environments.
     * @param perpendicularWeight The weight applied to the perpendicular distance component. Increased weight
     *                            discourages deviations from the straight line between the start and target, resulting
     *                            in smoother paths.
     * @param heightWeight        The weight applied to the height difference (elevation change) component. A higher
     *                            weight gives more consideration to vertical distance, important for terrains with
     *                            varying verticality.
     *
