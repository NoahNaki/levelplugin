...
public interface EvaluationContext {
   ...
   * is being reached. This is the position of the parent A* Node. This will be {@code null} if the
   * {@code currentPathPosition} is the start position being evaluated initially.
   *
  ...
  /**
   * Returns the heuristic value (H-cost) calculated by the pathfinding engine for the {@link
   * #getCurrentPathPosition() current PathPosition} towards the target. This is the engine's
   * estimate *before* any processor adjustments might influence path choices.
   *
  ...
  /**
   * Returns the accumulated G-cost (actual known cost from start) up to the {@link
   * #getPreviousPathPosition() previous PathPosition}. This value is derived from {@code
   * getParentEngineNode().getGCost()}. If {@code previousPathPosition} is {@code null} (i.e.,
   * current is start), this returns 0.
   *
  ...
  /**
   * Convenience method to access the pathfinder configuration. Delegates to {@link
   * SearchContext#getPathfinderConfiguration()}.
   */
  ...
  /**
   * Convenience method to access the navigation point provider. Delegates to {@link
  ...
  /**
   * Convenience method to access the shared data map for the overall search. Delegates to {@link
   * SearchContext#getSharedData()}.
   */
  ...
  /**
   * Convenience method to access the start PathPosition of the overall search. Delegates to {@link
   * SearchContext#getStartPathPosition()}.
   */
  ...
  /**
   * Convenience method to access the target PathPosition of the overall search. Delegates to {@link
   * SearchContext#getTargetPathPosition()}.
   */
