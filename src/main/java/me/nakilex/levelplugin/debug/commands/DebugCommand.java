...
import me.nakilex.levelplugin.debug.stronghold.StrongholdDebugService;
...
public class DebugCommand implements TabExecutor {
    ...
    private final StrongholdDebugService strongholdDebugService = new StrongholdDebugService();
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        switch (sub) {
            ...
            case "stronghold":
                ...
                strongholdDebugService.run(strongholdPlayer, Arrays.copyOfRange(args, 1, args.length));
                return true;
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        if (args.length == 1) {
            ...
            return strongholdDebugService.tabComplete(args);
        }
