...
public class QuestManager {
    ...
    private void registerDefaultQuests() {
        ...
        registerNpcQuest(me.nakilex.levelplugin.quests.def.ForgeFundamentalsQuest.NPC_ID,
    ...
    private String resolveNpcName(String raw) {
        ...
        if (digits.length() > 0) {
            try {
                ...
                me.nakilex.levelplugin.npc.system.NPC npc = me.nakilex.levelplugin.npc.system.NpcApi.getRegistry().getById(id);
                if (npc != null) {
                    return npc.getName();
                }
