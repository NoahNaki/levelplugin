...
public class DivinePresets implements ParticlePresetProvider {
    ...
    public void register(ParticlePresetRegistry registry) {
        registry.register("HEALING_AURA", new ParticlePreset(Particle.HEART, null, 0.03, 0.06, 0.03, 0.0));
        registry.register("CELESTIAL", new ParticlePreset(Particle.END_ROD, null, 0.01, 0.01, 0.01, 0.0));
