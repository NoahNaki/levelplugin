...
/** Utility methods to convert mob IDs to human-friendly names. */
public final class MobNameUtil {
     ...
     *
     * @param rawName mob internal name
    ...
    /**
     * Look up the configured display name for a custom mob ID. Falls back to a prettified
     * version of the ID if the mob or its display name cannot be found.
     *
     * @param mobId mob internal ID
     ...
     * same value.
     *
     * @param mobId mob identifier or display alias
    ...
    public static String canonicalMobKey(String mobId) {
        ...
        String base = getPlainDisplayName(mobId);
