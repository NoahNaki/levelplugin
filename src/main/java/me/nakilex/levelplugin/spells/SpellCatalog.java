    ...
    private static void registerDeckFireballs(SpellRegistry registry, Main plugin) {
        ...
        registerDeckFireball(registry, plugin, "deck_fireball_mythic", "Worldfire", 75,
                new DeckFireballSpell.Config(5, 250, 75, 14, 5.0, 10, 30, 0.95,
                        ...
                        true, 4, 140, 10,
                        1.0, 0.10, 0.55f));
        registry.registerProgression(new SpellProgression("deck_fireball_common", java.util.List.of(
                "deck_fireball_uncommon", "deck_fireball_rare", "deck_fireball_epic",
                "deck_fireball_legendary", "deck_fireball_mythic")));
    }
