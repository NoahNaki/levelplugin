                ...
                new BukkitRunnable() {
                    ...
                    public void run() {
                        ...
                        for (Entity e : arrow.getNearbyEntities(1,1,1)) {
                            ...
                            SpellUtils.dealWithChat(player, le, damage, "Arrow Shower");
                            le.setFireTicks(60);
                        }
                    }
