    ...
    private void loadSpells() {
        ...
        spellsByClass.put("warrior", Map.of(
            ...
            "RRR", new Spell("heroic_leap", "Heroic Leap", "RRR", 10, 0, 2,
                Arrays.asList(Material.WOODEN_SHOVEL, Material.STONE_SHOVEL, Material.IRON_SHOVEL, Material.GOLDEN_SHOVEL, Material.DIAMOND_SHOVEL, Material.NETHERITE_SHOVEL),
                "HEROIC_LEAP", 1.2),
            "RRL", new Spell("uppercut", "Uppercut", "RRL", 15, 4, 5,
                Arrays.asList(Material.WOODEN_SHOVEL, Material.STONE_SHOVEL, Material.IRON_SHOVEL, Material.GOLDEN_SHOVEL, Material.DIAMOND_SHOVEL, Material.NETHERITE_SHOVEL),
                "UPPERCUT", 1.3),
        ...
        spellsByClass.put("mage", Map.of(
            ...
            "RLR", new Spell("heal", "Heal", "RLR", 15, 0, 5, Arrays.asList(Material.STICK, Material.BLAZE_ROD), "HEAL", 0.0),
        ...
        spellsByClass.put("rogue", Map.of(
            "RLL", new Spell("shadow_step", "Shadow Step", "RLL", 12, 0, 1,
        ...
        spellsByClass.put("archer", Map.of(
            "LLR", new Spell("power_shot", "Power Shot", "LLR", 12, 0, 1, Arrays.asList(Material.BOW, Material.CROSSBOW), "POWER_SHOT", 2.0),
            "LRR", new Spell("explosive_arrow", "Explosive Arrow", "LRR", 15, 0, 1, Arrays.asList(Material.BOW, Material.CROSSBOW), "EXPLOSIVE_ARROW", 1.5),
            "LLL", new Spell("grapple_hook", "Grapple Hook", "LLL", 8, 0, 1, Arrays.asList(Material.BOW, Material.CROSSBOW), "GRAPPLE_HOOK", 0.0),
            "LRL", new Spell("arrow_storm", "Arrow Storm", "LRL", 20, 0, 1, Arrays.asList(Material.BOW, Material.CROSSBOW), "ARROW_STORM", 0.5)
        ));
    }
