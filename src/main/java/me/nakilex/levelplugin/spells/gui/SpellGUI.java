...
public class SpellGUI {
    ...
    static {
        ...
        // Windrune
        SPELL_DESCRIPTIONS.put("gale_slash", "Slash with wind-infused strikes.");
        SPELL_DESCRIPTIONS.put("vault", "Leap high propelled by wind.");
        SPELL_DESCRIPTIONS.put("dancing_blade", "Dance through foes with slashes.");
        SPELL_DESCRIPTIONS.put("torrent", "Spin rapidly drawing enemies in.");
        SPELL_DESCRIPTIONS.put("cloudpiercer", "Hurl a piercing spear of wind.");
        SPELL_DESCRIPTIONS.put("windbound_fury", "Unleash a raging wind storm.");
    }
    ...
    static {
        ...
        SPELL_USAGE.put("torrent", "Sneak");
        SPELL_USAGE.put("cloudpiercer", "Sneak + Toggle");
