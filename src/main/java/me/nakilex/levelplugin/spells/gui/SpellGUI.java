...
public class SpellGUI {
    ...
    static {
        ...
        SPELL_DESCRIPTIONS.put("death_strike", "Slash forward with necrotic power.");
        SPELL_DESCRIPTIONS.put("phantom_charge", "Dash ahead and damage foes in your path.");
        SPELL_DESCRIPTIONS.put("wraithbound_chains", "Throw chains to pull enemies to you.");
        SPELL_DESCRIPTIONS.put("soul_barrier", "Form a shield that heals when struck.");
        SPELL_DESCRIPTIONS.put("necrotic_whirlwind", "Spin with dark energy to drain foes.");
        SPELL_DESCRIPTIONS.put("death_sentence", "Rise up then slam down with deadly force.");
    }
    ...
    static {
        ...
        SPELL_USAGE.put("soul_barrier", "Sneak (Hold)");
    ...
    public static void openSpellGUI(Player player) {
        ...
        if (weapon != null && weapon.hasItemMeta()) {
            ...
            if (pdc.has(ItemUtil.EGO_ID_KEY, PersistentDataType.STRING)) {
                ...
                else if (prefix.equalsIgnoreCase("death_knight")) classKey = "deathknight";
            }
        }
