...
public class ModelGate {
    ...
    public void spawnEntities(Plugin plugin) {
        ...
        NexoUtil.removeAllFurniture(centered);
    ...
    public void removeAll() {
        // remove all furniture at the gate's location to prevent duplicate
        // entities from accumulating across restarts
        NexoUtil.removeAllFurniture(LocationUtils.centerOnBlock(location));
        openEntity = null;
        closedEntity = null;
    }
}
